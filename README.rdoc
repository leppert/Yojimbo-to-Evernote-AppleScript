...
- It has *NOT* been tested against recent versions of Yojimbo or Evernote.
- The last noted tests of this script were run in December of 2008 against what was then the most current versions of both applications.
